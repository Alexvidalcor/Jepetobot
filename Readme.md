...
| :exclamation:  Check the [Wiki](https://github.com/Alexvidalcor/TelegramBot/wiki) for more info!  |
|-----------------------------------------|
...
For detailed information, check the project [Wiki](https://github.com/Alexvidalcor/TelegramBot/wiki)
...
* I'm not responsible for possible high cloud costs generated by using the code of this project.
    * **You** are free to use the software of this project and it is your decision. As I explain in the [wiki](https://github.com/Alexvidalcor/TelegramBot/wiki), this project originates from an experiment and fully stable operation is not guaranteed.
