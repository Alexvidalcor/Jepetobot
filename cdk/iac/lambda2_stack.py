...
# Custom importation
from env.cdk_public_env import stopHour, stopMinute, enableScheduler
...
class Lambda2Stack(Stack):
    ...
    def __init__(self, scope: Construct, id: str, **kwargs) -> None:
        ...
        with open("lambda_data/lambda2/ec2_stop_instance.py", "r") as fLambdaRead:
        ...
        lambdaRole = iam.Role(self, appName + "_Lambda2-role",
